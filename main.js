...
let AuthService = class AuthService {
    ...
    logIn(userlogin) {
        ...
        return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].baseUrl + 'login', userlogin)
...
const routes = [
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | login-login-module */ "login-login-module").then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(mod => mod.LoginModule)
    },
    {
        path: 'admin',
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
        loadChildren: () => __webpack_require__.e(/*! import() | admin-admin-module */ "admin-admin-module").then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then(mod => mod.AdminModule)
    },
...
SharedComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./shared.component.scss */ "./src/app/shared/shared.component.scss")).default]
    })
], SharedComponent);
...
module.exports = __webpack_require__(/*! D:\JAVA_Workspace\FE\src\main.ts */"./src/main.ts");
